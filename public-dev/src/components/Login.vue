                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">{{ $t('PAGES.LOGIN.CLIENT_AREA') }}</h1>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" :placeholder="$t('PAGES.LOGIN.PASSWORD')" class="form-control"
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="/forgot-password" class="small text-right">{{ $t('PAGES.LOGIN.RECOVER_MY_PASSWORD') }}</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                                <button type="button" class="btn btn-gray-800" v-on:click="login">{{ $t('PAGES.LOGIN.GET_IN') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
